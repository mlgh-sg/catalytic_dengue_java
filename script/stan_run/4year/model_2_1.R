...
if (model_no %in% c(1:2)){
  data_list <- readRDS("data/data_4year_list.rds") 
} else if (model_no %in% c(3:4)){
  data_list <- readRDS("data/data_indiv_4year_list.rds") 
}
...
# save output
saveRDS(stanfit,paste0("output/stan_fit/fit_",model_no,"_",province,"_4year.rds"))